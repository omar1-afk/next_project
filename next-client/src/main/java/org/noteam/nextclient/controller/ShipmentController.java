...
public class ShipmentController {
    ...
    public void initialize() {
        ...
        completedShipmentIdColumn.setCellValueFactory(c -> c.getValue().shipmentIdProperty().asObject()
        ...
        incompletedShipmentIdColumn.setCellValueFactory(c -> c.getValue().shipmentIdProperty().asObject());
