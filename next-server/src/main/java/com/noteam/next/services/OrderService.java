...
public class OrderService {
    ...
    public boolean createOrder(OrderRequest request) {
        ...
        Sender sender = senderRepository.findByEmail(request.senderEmail());
        Receiver receiver = receiverRepository.findByEmail(request.receiverEmail());
    ...
    // Optional<City> cityOptional= cityRepository.findById(request.cityId());
    // Optional<Sender> senderOptional=
    // senderRepository.findById(request.senderId());
    // Optional<Receiver> receiverOptional=
    // receiverRepository.findById(request.receiverId());
